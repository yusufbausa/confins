...
WebUI.waitForElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Payment Reversal'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Payment Reversal'), 30)
WebUI.verifyElementClickable(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Payment Reversal'))
WebUI.click(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Payment Reversal'))
WebUI.delay(1)


//INPUT CUSTOMER CREDENTIAL ========================================================================================================================================================================================================================================================================
WebUI.waitForElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_Agreement No_ucSearchtxtAgrmntNo_ltlAgrmntAgrmntNoSearch'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_Agreement No_ucSearchtxtAgrmntNo_ltlAgrmntAgrmntNoSearch'), 30)
WebUI.verifyElementClickable(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_Agreement No_ucSearchtxtAgrmntNo_ltlAgrmntAgrmntNoSearch'))
...
WebUI.waitForElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_IDR_gvPaymentReversalctl02imbEdit'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_IDR_gvPaymentReversalctl02imbEdit'), 30)
WebUI.verifyElementClickable(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_IDR_gvPaymentReversalctl02imbEdit'))
...
WebUI.waitForElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Reverse'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Reverse'), 30)
WebUI.verifyElementClickable(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Reverse'))
WebUI.click(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Reverse'))
WebUI.delay(1)

WebUI.waitForElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_Reference No_txtRefNo'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_Reference No_txtRefNo'), 30)
WebUI.verifyElementClickable(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_Reference No_txtRefNo'))
WebUI.setText(findTestObject('Object Repository/PAYMENT/Payment Reversal/input_Reference No_txtRefNo'), refNo)

WebUI.waitForElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/textarea_Notes_txtNotes'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/textarea_Notes_txtNotes'), 30)
WebUI.verifyElementClickable(findTestObject('Object Repository/PAYMENT/Payment Reversal/textarea_Notes_txtNotes'))
WebUI.setText(findTestObject('Object Repository/PAYMENT/Payment Reversal/textarea_Notes_txtNotes'), notes)
WebUI.delay(2)

WebUI.waitForElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Submit'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Submit'), 30)
WebUI.verifyElementClickable(findTestObject('Object Repository/PAYMENT/Payment Reversal/a_Submit'))
