...
WebUI.selectOptionByValue(findTestObject('New Application (NEW)/Guarantor/Page_New Confins 1 - Main/select_customer_type'), 'P', false)
...
WebUI.selectOptionByValue(findTestObject('New Application (NEW)/Guarantor/Page_New Confins 1 - Main/select_customer_relationship'), 'GUARANTOR', false)
...
WebUI.waitForElementPresent(findTestObject('New Application (NEW)/Application Data/input_Yes_rblIsFudiciaCovered'), 30)
WebUI.verifyElementPresent(findTestObject('New Application (NEW)/Application Data/input_Yes_rblIsFudiciaCovered'), 30)
WebUI.verifyElementClickable(findTestObject('New Application (NEW)/Application Data/input_Yes_rblIsFudiciaCovered'))
