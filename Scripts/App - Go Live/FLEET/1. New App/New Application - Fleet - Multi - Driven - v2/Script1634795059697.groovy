...
WebUI.waitForElementPresent(findTestObject('FLEET/Asset Data/Multi/button_registration_asset_2'), 30)
WebUI.verifyElementPresent(findTestObject('FLEET/Asset Data/Multi/button_registration_asset_2'), 30)
WebUI.verifyElementClickable(findTestObject('FLEET/Asset Data/Multi/button_registration_asset_2'))
...
//Insurance Asset 2
WebUI.waitForElementPresent(findTestObject('FLEET/Insurance Data/Multi/button_edit_insurance_no_2'), 30)
WebUI.verifyElementPresent(findTestObject('FLEET/Insurance Data/Multi/button_edit_insurance_no_2'), 30)
WebUI.verifyElementClickable(findTestObject('FLEET/Insurance Data/Multi/button_edit_insurance_no_2'))
