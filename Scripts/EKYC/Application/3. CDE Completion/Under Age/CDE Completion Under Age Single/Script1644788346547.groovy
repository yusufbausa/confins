...
WebUI.selectOptionByLabel(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_education'), 'SMA', false)
WebUI.setText(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/field_mother_name'), motherName)
WebUI.delay(1)
	
	
//contact data
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_call_reason'), '538', false)
WebUI.delay(1)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_job_position'), 'JPEXEC', false)
...
//WebUI.delay(1)
WebUI.selectOptionByLabel(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_job_status'), 'OTHERS', false)
WebUI.delay(1)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_residence_address'), 'Residence Address', false)
WebUI.click(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/btn_copy_residence_address'))
WebUI.delay(1)

WebUI.selectOptionByLabel(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_address_type'), 'Legal Address', false)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_ownership'), 'SELF', false)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_legal_address1'), 'LEGAL', false)
WebUI.click(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/btn_copy_residence_address'))
WebUI.delay(1)

WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_building_type'), 'Apartment', false)
WebUI.delay(1)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_cust_relationship'), 'FATHER', false)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_business_scale'), '03', false)
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_way_of_payment'), 'ADBCA', false)
WebUI.delay(1)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/EKYC/Application/CDE Completion Personal/select_legal_address_asset'), 'LEGAL', false)
//WebUI.delay(1)
