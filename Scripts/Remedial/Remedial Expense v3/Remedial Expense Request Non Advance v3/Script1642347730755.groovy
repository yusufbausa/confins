...
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_disburse_to'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_disburse_to'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_disburse_to'))
...
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/select_bank_name'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/select_bank_name'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/select_bank_name'))
WebUI.selectOptionByLabel(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/select_bank_name'), 
    bankName, false)

WebUI.waitForElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_bank_branch'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_bank_branch'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_bank_branch'))
WebUI.setText(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_bank_branch'), 
    bankBranch)

WebUI.waitForElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_account_no'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_account_no'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_account_no'))
WebUI.setText(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_account_no'), 
    accountNo)

WebUI.waitForElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_account_name'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_account_name'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Remedial Expense v3/Remedial Expense Request v3/field_account_name'))
