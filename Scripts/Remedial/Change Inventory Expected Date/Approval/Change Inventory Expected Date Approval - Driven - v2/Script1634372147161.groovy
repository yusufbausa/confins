...
WebUI.setText(findTestObject('Login/username'), usernameApprRA1)
...
//select role
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Change Asset Expected Date Approval/button_select_role'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Change Asset Expected Date Approval/button_select_role'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Change Asset Expected Date Approval/button_select_role'))
