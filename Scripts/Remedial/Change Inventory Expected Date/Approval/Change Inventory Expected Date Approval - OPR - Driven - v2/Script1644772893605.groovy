...
//select role
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Change Asset Expected Date Approval/button_select_role_opr'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Change Asset Expected Date Approval/button_select_role_opr'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Change Asset Expected Date Approval/button_select_role_opr'))
WebUI.click(findTestObject('REMEDIAL/Change Asset Expected Date Approval/button_select_role_opr'))  //role as remedial area 1
WebUI.delay(1)

//select menu inventory expected date approval
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Change Asset Expected Date Approval/things_ToDo_change_inv_expected_date_approval'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Change Asset Expected Date Approval/things_ToDo_change_inv_expected_date_approval'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Change Asset Expected Date Approval/things_ToDo_change_inv_expected_date_approval'))
