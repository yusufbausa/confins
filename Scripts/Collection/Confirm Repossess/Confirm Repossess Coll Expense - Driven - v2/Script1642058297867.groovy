...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/img_search_zipCode'), 30)
WebUI.verifyElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/img_search_zipCode'), 30)
WebUI.verifyElementClickable(findTestObject('COLLECTION/Repossession Collection Expense/img_search_zipCode'))
WebUI.click(findTestObject('COLLECTION/Repossession Collection Expense/img_search_zipCode'))

WebUI.waitForElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/field_kelurahan'), 30)
WebUI.verifyElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/field_kelurahan'), 30)
WebUI.verifyElementClickable(findTestObject('COLLECTION/Repossession Collection Expense/field_kelurahan'))
WebUI.setText(findTestObject('COLLECTION/Repossession Collection Expense/field_kelurahan'),
	'%pancoran%')

WebUI.waitForElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/btn_search'), 30)
WebUI.verifyElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/btn_search'), 30)
WebUI.verifyElementClickable(findTestObject('COLLECTION/Repossession Collection Expense/btn_search'))
WebUI.click(findTestObject('COLLECTION/Repossession Collection Expense/btn_search'))

WebUI.waitForElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/btn_select_zipCode'), 30)
WebUI.verifyElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/btn_select_zipCode'), 30)
WebUI.verifyElementClickable(findTestObject('COLLECTION/Repossession Collection Expense/btn_select_zipCode'))
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/field_license_plate'), 30)
WebUI.verifyElementPresent(findTestObject('COLLECTION/Repossession Collection Expense/field_license_plate'), 30)
WebUI.verifyElementClickable(findTestObject('COLLECTION/Repossession Collection Expense/field_license_plate'))
