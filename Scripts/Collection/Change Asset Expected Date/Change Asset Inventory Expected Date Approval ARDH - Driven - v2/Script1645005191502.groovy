...
WebUI.setText(findTestObject('Login/username'), usernameARDH)
...
//select role
WebUI.waitForElementPresent(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Req/select_role_ardh'), 30)
WebUI.verifyElementPresent(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Req/select_role_ardh'), 30)
WebUI.verifyElementClickable(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Req/select_role_ardh'))
WebUI.click(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Req/select_role_ardh'))  // select AR Management Head Dept. Head
WebUI.delay(1)
