...
WebUI.waitForElementPresent(findTestObject('Object Repository/COPY CANCEL/App Inquiry/img_Welcome, ANGGO BAGUS WICAKSONO, TANGERA_797734'), 20)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/COPY CANCEL/App Inquiry/input_Application No._ucSearchtxtAppNo_ltlAppAppNoSearch'), 20)
